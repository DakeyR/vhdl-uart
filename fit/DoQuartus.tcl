...
# set_global_assignment -name VHDL_FILE "../src/______.vhd"
  set_global_assignment -name VHDL_FILE "../src/MAE_Rec.vhd"
  set_global_assignment -name VHDL_FILE "../src/mux.vhd"
  set_global_assignment -name VHDL_FILE "../src/sel.vhd"
  set_global_assignment -name VHDL_FILE "../src/filter.vhd"
  set_global_assignment -name VHDL_FILE "../src/MAE_Emission.vhd"
  set_global_assignment -name VHDL_FILE "../src/UART_Reception.vhd"
  set_global_assignment -name VHDL_FILE "../src/UART_Emission.vhd"
...
#  set_global_assignment -name VHDL_FILE "../src/DE2_top.vhd"
  ...
  set_global_assignment -name VHDL_FILE "../src/DE2_top.vhd"
  set_global_assignment -name VHDL_FILE "../src/Ultrasound.vhd"
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_INT0
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_INT1
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_DACK0_N
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_DACK1_N
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_DREQ0
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to OTG_DREQ1
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to TD_RESET
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_R[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_R[9]
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_G[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_G[9]
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_B[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to VGA_B[9]
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to TD_CLK
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[7]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[9]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[10]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[11]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[12]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[13]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[14]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_DATA[15]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_CLK
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_CMD
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_CS_N
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_INT
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_RD_N
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_WR_N
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to ENET_RST_N
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL"  -to GPIO_1[35]
  ...
  if [file exists ${MyProj}.rbf]  {
    ...
    if { [file exists C:/altera/12.1/quartus/bin64/quartus_pgmw.exe]} {
   
      exec cmd.exe /c C:/altera/12.1/quartus/bin64/quartus_pgmw.exe ${MyProj}.sof
